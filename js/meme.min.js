...
`){s+=n[1];break}s+=n[0]}return s}},{once:!0});const updateReadingProgress=()=>{const e=document.querySelector("#reading-progress");if(!e)return;const t=document.documentElement.scrollHeight-document.documentElement.clientHeight;if(t<=0){e.style.width="0%";return}const n=window.scrollY/t*100;e.style.width=`${n}%`};document.addEventListener("DOMContentLoaded",()=>{document.addEventListener("scroll",updateReadingProgress),updateReadingProgress()})